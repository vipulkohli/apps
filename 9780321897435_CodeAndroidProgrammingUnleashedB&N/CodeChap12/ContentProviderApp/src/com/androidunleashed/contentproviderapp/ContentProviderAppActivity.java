...
public class ContentProviderAppActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(contactRows.isEmpty()) {
            ArrayAdapter<String> arrayAdpt=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, nocontact); 
            contactsList.setAdapter(arrayAdpt);  
        }
        else {
            ArrayAdapter<String> arrayAdpt=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, contactRows); 
            contactsList.setAdapter(arrayAdpt);  
        }
    }
}
